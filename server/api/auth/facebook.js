...
const radix = 10;
const PORT = parseInt(process.env.VITE_DEV_API_SERVER_PORT, radix);
const rootUrl = process.env.VITE_MARKETPLACE_ROOT_URL;
const clientID = process.env.VITE_FACEBOOK_APP_ID;
const clientSecret = process.env.FACEBOOK_APP_SECRET;

const FacebookStrategy = passportFacebook.Strategy;
let callbackURL = null;

const useDevApiServer = process.env.VITE_ENV === 'development' && !!PORT;
