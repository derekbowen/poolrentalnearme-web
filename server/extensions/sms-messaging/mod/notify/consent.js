...
// did nothing at all.
//
// Three states, not two. Accounts created before the checkbox shipped carry
// no field whatsoever. An absent field is not a yes, but it is not a recorded
// no either, so it gets its own state and its own policy knob. Collapsing
// 'unknown' into either answer is how a blast either silently drops hosts who
// did consent, or texts hosts who never did.
//
