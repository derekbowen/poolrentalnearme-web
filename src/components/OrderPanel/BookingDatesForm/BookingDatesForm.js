...
import { Form, PrimaryButton, SecondaryButton, FieldDateRangePicker, FieldSelect, H6 } from '../../../components';
...
const calculateLineItems = (
  ...
  const { startDate, endDate, priceVariantName, seats, amenities } = formValues?.values || {};
  ...
  return (
    <FinalForm
      ...
      render={formRenderProps => {
        ...
        const { startDate, endDate, amenities: selectedAmenities } = values?.bookingDates ? values.bookingDates : {};
