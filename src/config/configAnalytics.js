...
// This adds data-domains for Plausible script through environment variable: VITE_PLAUSIBLE_DOMAINS
...
// E.g. VITE_PLAUSIBLE_DOMAINS=example1.com,example2.com
export const plausibleDomains = import.meta.env.VITE_PLAUSIBLE_DOMAINS;
