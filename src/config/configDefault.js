...
const defaultConfig = {
  ...
  marketplaceRootURL: import.meta.env.VITE_MARKETPLACE_ROOT_URL,
  ...
  marketplaceName: import.meta.env.VITE_MARKETPLACE_NAME || 'Biketribe',

  // Modify Stripe configuration in configStripe.js
  // - picks VITE_STRIPE_PUBLISHABLE_KEY from environment variables
