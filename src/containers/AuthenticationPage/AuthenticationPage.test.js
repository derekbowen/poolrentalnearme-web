...
describe('AuthenticationPage', () => {
  beforeEach(() => {
    ...
    process.env = Object.assign(process.env, { VITE_FACEBOOK_APP_ID: '' });
    process.env = Object.assign(process.env, { VITE_GOOGLE_CLIENT_ID: '' });
  });
...
describe('AuthenticationPage with SSO', () => {
  ...
  it('has social login buttons on login tab when the env variables are in place', () => {
    // We want to make sure that during the test the env variables
    // for social logins are as we expect them to be
    process.env = Object.assign(process.env, { VITE_FACEBOOK_APP_ID: 'test-fb' });
    process.env = Object.assign(process.env, { VITE_GOOGLE_CLIENT_ID: 'test-google' });
