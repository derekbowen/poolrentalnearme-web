...
import {
  ...
  selectStripeConnected,
} from '../../extensions/off-session-payment/ducks/offSessionPayment.duck';
...
const EnhancedCheckoutPage = (props) => {
  ...
  useEffect(() => {
    ...
    const data = handlePageData(initialData, STORAGE_KEY, navigationType);
    setPageData(data || {});
...
const CheckoutPage = connect(mapStateToProps, mapDispatchToProps)(EnhancedCheckoutPage);
