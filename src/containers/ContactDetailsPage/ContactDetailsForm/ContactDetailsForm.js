  ...
  const validateMaybe = isRequired
    ? {
        validate: composeValidators(
          ...
          validPhoneNumber(
            intl.formatMessage({
              id: 'ContactDetailsForm.phoneNumberInvalid',
            })
          )
        ),
      }
    ...
    return (
      <FinalForm
        ...
        render={fieldRenderProps => {
          ...
          const emailRequired = fieldRequired(emailRequiredMessage);
          ...
          const passwordValidators = emailChanged
            ? composeValidators(passwordRequired, passwordMinLength)
            : null;
          ...
          const submitDisabled = invalid || inProgress || !(emailChanged || phoneNumberChanged);
