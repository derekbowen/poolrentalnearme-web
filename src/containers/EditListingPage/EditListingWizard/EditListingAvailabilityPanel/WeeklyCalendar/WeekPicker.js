            ...
            <PickerForm initialValues={initialValues}>
              <FieldDateRangeController
                ...
                onMonthChange={(selectedDate) => {
                  const localizedDate = timeOfDayFromLocalToTimeZone(selectedDate, timeZone);
                  setCurrentMonth(localizedDate < currentMonth ? prevMonthFn : nextMonthFn);
                }}
                {...rest}
              />
            </PickerForm>
