...
import { MINIMUM_AMENITIES } from 'config/configListing';
...
const getInitialValues = props => {
  ...
  const { unitType, refundableDeposit, amenities, isInstantBooking } = publicData || {};
    ...
    <div className={classes}>
      ...
      {priceCurrencyValid ? (
        <EditListingPricingForm
          ...
          onSubmit={(values) => {
            const { price, amenities, refundableDeposit, isInstantBooking } = values;
