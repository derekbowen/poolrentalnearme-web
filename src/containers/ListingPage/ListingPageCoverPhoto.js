...
// Contexts
import { advantagesSelector } from 'ducks/hostedAssets.duck';
...
// Shared components
import { H4, Page, NamedLink, NamedRedirect, LayoutSingleColumn, Heading } from '../../components';
...
export const ListingPageComponent = (props) => {
  ...
  const advantages = useSelector(advantagesSelector);
