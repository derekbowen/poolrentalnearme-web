...
export const PasswordResetPageComponent = (props) => {
  ...
  const { scrollingDisabled, resetPasswordInProgress, resetPasswordError, onSubmitPassword } =
    props;
...
const PasswordResetPage = connect(mapStateToProps, mapDispatchToProps)(PasswordResetPageComponent);
