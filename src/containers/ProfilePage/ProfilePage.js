...
import { ButtonTabNavHorizontal } from 'components/TabNavHorizontal/TabNavHorizontal';
...
export const ProfilePageComponent = props => {
  ...
  const { scrollingDisabled, currentUser, useCurrentUser, userShowError, user, ...rest } = props;
