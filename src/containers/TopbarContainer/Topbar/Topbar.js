...
const redirectToURLWithModalState = (props, modalStateParam) => {
  ...
  setSearchParams((prevParams) => {
    prevParams.append(modalStateParam, 'open');
    return prevParams;
  });
};
...
const redirectToURLWithoutModalState = (props, modalStateParam) => {
  const { setSearchParams } = props;
  setSearchParams((prevParams) => {
    prevParams.delete(modalStateParam);
    return prevParams;
  });
};
...
const TopbarComponent = (props) => {
  ...
  const handleSubmit = (values) => {
    ...
    navigate(createResourceLocatorString(routeName, routeConfiguration, pathParams, searchParams));
  };
  ...
  const mobileSearchButtonMaybe = showSearchForm ? (
    <Button
      ...
      onClick={() => redirectToURLWithModalState(props, 'mobilesearch')}
    ...
    <div className={classes}>
      ...
      <div className={classNames(mobileRootClassName || css.container, mobileClassName)}>
        <Button
          ...
          onClick={() => redirectToURLWithModalState(props, 'mobilemenu')}
      ...
      <Modal
        ...
        onClose={() => redirectToURLWithoutModalState(props, 'mobilemenu')}
        usePortal
      ...
      <Modal
        ...
        onClose={() => redirectToURLWithoutModalState(props, 'mobilesearch')}
        usePortal
        onManageDisableScrolling={onManageDisableScrolling}
      >
