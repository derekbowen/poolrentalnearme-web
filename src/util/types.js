...
export const LINE_ITEM_AMENITY = 'line-item/amenity-';
...
export const EXCEED_RATE_LIMIT_CODE = 'exceed-rate-limit';
export const INVALID_OTP_CODE = 'invalid-otp';
...
export const ERROR_CODE_MISSING_DEFAULT_PAYMENT_METHOD =
  'transaction-stripe-customer-missing-default-payment-method';
